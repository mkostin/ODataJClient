...
@EntitySet("AllGeoTypesSet")
public interface AsyncAllGeoTypesSet extends AbstractAsyncEntitySet<com.msopentech.odatajclient.proxy.AstoriaDefaultService.types.AllSpatialTypes, Integer> {
