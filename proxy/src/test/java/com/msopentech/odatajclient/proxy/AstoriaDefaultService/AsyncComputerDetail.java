...
@EntitySet("ComputerDetail")
public interface AsyncComputerDetail extends AbstractAsyncEntitySet<com.msopentech.odatajclient.proxy.AstoriaDefaultService.types.ComputerDetail, Integer> {
