...
@EntitySet("MessageAttachment")
public interface AsyncMessageAttachment extends AbstractAsyncEntitySet<com.msopentech.odatajclient.proxy.AstoriaDefaultService.types.MessageAttachment, UUID> {
