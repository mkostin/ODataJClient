...
@EntitySet(name = "Row")
public interface AsyncRow extends AbstractAsyncEntitySet<com.msopentech.odatajclient.proxy.opentypeservice.microsoft.test.odata.services.opentypesservice.types.Row, UUID> {
}
