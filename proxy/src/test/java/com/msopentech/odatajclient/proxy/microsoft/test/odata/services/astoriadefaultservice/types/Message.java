...
public interface Message extends Serializable {
    ...
    public com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.Login getSender();

    public void setSender(final com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.Login _sender);
    ...
    @NavigationProperty(name = "Recipient", 
                ...
                containsTarget = false,
                onDelete = Action.NONE)
    public com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.Login getRecipient();

    public void setRecipient(final com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.Login _recipient);
    ...
    @NavigationProperty(name = "Attachments", 
                ...
                containsTarget = false,
                onDelete = Action.NONE)
    public Collection<com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.MessageAttachment> getAttachments();

    public void setAttachments(final Collection<com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.MessageAttachment> _attachments);
