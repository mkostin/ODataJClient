...
@EntitySet(name = "Car")
public interface AsyncCar extends AbstractAsyncEntitySet<com.msopentech.odatajclient.proxy.defaultservice.microsoft.test.odata.services.astoriadefaultservice.types.Car, Integer> {
}
