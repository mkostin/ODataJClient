...
public interface AsyncDefaultContainer extends AbstractContainer {
    ...
    Future<com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.CustomerCollection> getSpecificCustomer(
    ...
    void resetDataSource(
        ...
        @FunctionImport(name = "InStreamErrorGetCustomer" , 
                    ...
                    httpMethod = HttpMethod.GET ,
                    returnType = "Collection(Microsoft.Test.OData.Services.AstoriaDefaultService.Customer)")
    Future<com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.CustomerCollection> inStreamErrorGetCustomer(
    );
            }
