...
public interface AsyncDefaultContainer {
    ...
    Future<Collection<com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.Customer>> getSpecificCustomer(
    ...
    Future<Collection<com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.ContactDetails>> entityProjectionReturnsCollectionOfComplexTypes(
    );
    ...
    Future<Collection<com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.Customer>> inStreamErrorGetCustomer(
    );
    ...
    Future<com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.Computer> getComputer(
