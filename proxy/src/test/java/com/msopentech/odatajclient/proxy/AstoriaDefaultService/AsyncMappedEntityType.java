...
@EntitySet("MappedEntityType")
public interface AsyncMappedEntityType extends AbstractAsyncEntitySet<com.msopentech.odatajclient.proxy.AstoriaDefaultService.types.MappedEntityType, Integer> {
