...
public interface DefaultContainer {
    ...
    Collection<com.msopentech.odatajclient.proxy.AstoriaDefaultService.types.Customer> getSpecificCustomer(
    ...
    Collection<com.msopentech.odatajclient.proxy.AstoriaDefaultService.types.ContactDetails> entityProjectionReturnsCollectionOfComplexTypes(
    );
    ...
    Collection<com.msopentech.odatajclient.proxy.AstoriaDefaultService.types.Customer> inStreamErrorGetCustomer(
    );
    ...
    com.msopentech.odatajclient.proxy.AstoriaDefaultService.types.Computer getComputer(
