...
public interface PersonMetadata extends Serializable {
    ...
    @NavigationProperty(name = "Person", 
                relationship = "Microsoft.Test.OData.Services.AstoriaDefaultService.PersonMetadata_Person", 
                fromRole = "PersonMetadata", 
                toRole = "Person",
                containsTarget = false,
                onDelete = Action.NONE)
    public com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.Person getPerson();

    public void setPerson(final com.msopentech.odatajclient.proxy.microsoft.test.odata.services.astoriadefaultservice.types.Person _person);
