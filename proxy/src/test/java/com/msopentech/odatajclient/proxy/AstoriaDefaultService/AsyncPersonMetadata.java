...
@EntitySet("PersonMetadata")
public interface AsyncPersonMetadata extends AbstractAsyncEntitySet<com.msopentech.odatajclient.proxy.AstoriaDefaultService.types.PersonMetadata, Integer> {
