...
public class TSchema extends AbstractElement {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "ValueTerm", type = TValueTerm.class),
    ...
    public List<TEntityType> getEntityTypes() {
        return getElements(TEntityType.class);
    }

    public List<TAssociation> getAssociations() {
        return getElements(TAssociation.class);
    }

    public List<TEntityContainer> getEntityContainers() {
        return getElements(TEntityContainer.class);
    }

    public List<TAnnotations> getAnnotations() {
        return getElements(TAnnotations.class);
    }
