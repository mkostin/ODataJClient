...
public class AssociationSetModificationFunctionMapping {
    ...
    protected AssociationSetModificationFunction deleteFunction;

    @XmlElement(name = "InsertFunction")
    protected AssociationSetModificationFunction insertFunction;
     ...
     *
     */
    public AssociationSetModificationFunction getDeleteFunction() {
     ...
     *
     */
    public void setDeleteFunction(AssociationSetModificationFunction value) {
     ...
     *
     */
    public AssociationSetModificationFunction getInsertFunction() {
     ...
     *
     */
    public void setInsertFunction(AssociationSetModificationFunction value) {
