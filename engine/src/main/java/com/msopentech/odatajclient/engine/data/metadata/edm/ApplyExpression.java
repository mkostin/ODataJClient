 ...
 *         &lt;group ref="{http://schemas.microsoft.com/ado/2009/11/edm}GExpression" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="Function" type="{http://schemas.microsoft.com/ado/2009/11/edm}TQualifiedName" />
...
public class ApplyExpression {
    ...
    protected List<Object> gExpression;
     ...
     *
     */
    public List<Object> getGExpression() {
        if (gExpression == null) {
            gExpression = new ArrayList<Object>();
        }
