...
public abstract class AbstractDeserializer extends AbstractJacksonMarshaller implements Deserializer {

    private static final long serialVersionUID = -4244158979195609909L;

    public AbstractDeserializer(final ODataClient client) {
        super(client);
    }
    ...
    protected XmlMapper getXmlMapper() {
        ...
        xmlMapper.setInjectableValues(new InjectableValues.Std().
                addValue(ODataConstants.Version.class, client.getWorkingVersion()));
