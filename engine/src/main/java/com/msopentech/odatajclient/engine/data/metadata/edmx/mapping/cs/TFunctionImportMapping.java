...
public class TFunctionImportMapping {

    @XmlElement(name = "ResultMapping")
    protected List<TFunctionImportMappingResultMapping> resultMapping;
     ...
     *
     */
    public List<TFunctionImportMappingResultMapping> getResultMapping() {
        if (resultMapping == null) {
            resultMapping = new ArrayList<TFunctionImportMappingResultMapping>();
        }
