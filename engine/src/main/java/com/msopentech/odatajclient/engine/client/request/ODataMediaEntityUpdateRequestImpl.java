 ...
 * java.io.InputStream)
 */
class ODataMediaEntityUpdateRequestImpl extends ODataRequestImpl implements ODataMediaEntityUpdateRequest {
     ...
     */
    ODataMediaEntityUpdateRequestImpl(final ODataURI editURI, final InputStream media) {
        super(Method.PUT);
        this.media = media;
        this.uri = editURI;
    }
