...
import com.msopentech.odatajclient.engine.data.metadata.edm.v3.ValueTerm;
import com.msopentech.odatajclient.engine.data.metadata.edm.v3.Association;
import com.msopentech.odatajclient.engine.data.metadata.edm.v3.Using;
...
import com.msopentech.odatajclient.engine.data.metadata.edm.v4.TypeDefinition;
...
public class SchemaDeserializer extends AbstractEdmDeserializer<AbstractSchema> {
    ...
    protected AbstractSchema doDeserialize(final JsonParser jp, final DeserializationContext ctxt)
        ...
        final AbstractSchema schema = ODataVersion.V3 == client.getWorkingVersion()
                ? new com.msopentech.odatajclient.engine.data.metadata.edm.v3.Schema()
                : new com.msopentech.odatajclient.engine.data.metadata.edm.v4.Schema();
        ...
        for (; jp.getCurrentToken() != JsonToken.END_OBJECT; jp.nextToken()) {
            ...
            if (token == JsonToken.FIELD_NAME) {
                if ("Namespace".equals(jp.getCurrentName())) {
                    ...
                    jp.nextToken();
                    ((com.msopentech.odatajclient.engine.data.metadata.edm.v3.Schema) schema).
                    ...
                    jp.nextToken();
                    if (schema instanceof com.msopentech.odatajclient.engine.data.metadata.edm.v3.Schema) {
                        ((com.msopentech.odatajclient.engine.data.metadata.edm.v3.Schema) schema).
                                getComplexTypes().add(jp.getCodec().readValue(jp,
                                                com.msopentech.odatajclient.engine.data.metadata.edm.v3.ComplexType.class));
                    } else {
                        ((com.msopentech.odatajclient.engine.data.metadata.edm.v4.Schema) schema).
                                getComplexTypes().add(jp.getCodec().readValue(jp,
                                                com.msopentech.odatajclient.engine.data.metadata.edm.v4.ComplexType.class));
                    }
                    ...
                    if (schema instanceof com.msopentech.odatajclient.engine.data.metadata.edm.v3.Schema) {
                        ((com.msopentech.odatajclient.engine.data.metadata.edm.v3.Schema) schema).
                                getEntityTypes().add(jp.getCodec().readValue(jp,
                                                com.msopentech.odatajclient.engine.data.metadata.edm.v3.EntityType.class));
                    } else {
                        ((com.msopentech.odatajclient.engine.data.metadata.edm.v4.Schema) schema).
                                getEntityTypes().add(jp.getCodec().readValue(jp,
                                                com.msopentech.odatajclient.engine.data.metadata.edm.v4.EntityType.class));
                    }
                    ...
                    if (schema instanceof com.msopentech.odatajclient.engine.data.metadata.edm.v3.Schema) {
                        ((com.msopentech.odatajclient.engine.data.metadata.edm.v3.Schema) schema).
                                getEnumTypes().add(jp.getCodec().readValue(jp,
                                                com.msopentech.odatajclient.engine.data.metadata.edm.v3.EnumType.class));
                    } else {
                        ((com.msopentech.odatajclient.engine.data.metadata.edm.v4.Schema) schema).
                                getEnumTypes().add(jp.getCodec().readValue(jp,
                                                com.msopentech.odatajclient.engine.data.metadata.edm.v4.EnumType.class));
                    }
                    ...
                    if (schema instanceof com.msopentech.odatajclient.engine.data.metadata.edm.v3.Schema) {
                        ((com.msopentech.odatajclient.engine.data.metadata.edm.v3.Schema) schema).
                                getEntityContainers().add(jp.getCodec().readValue(jp,
                                                com.msopentech.odatajclient.engine.data.metadata.edm.v3.EntityContainer.class));
                    } else {
                        com.msopentech.odatajclient.engine.data.metadata.edm.v4.EntityContainer entityContainer =
                                jp.getCodec().readValue(jp,
                                        com.msopentech.odatajclient.engine.data.metadata.edm.v4.EntityContainer.class);
                    ...
                    jp.nextToken();
                    if (schema instanceof com.msopentech.odatajclient.engine.data.metadata.edm.v3.Schema) {
                        ((com.msopentech.odatajclient.engine.data.metadata.edm.v3.Schema) schema).getAnnotationsList().
                                add(jp.getCodec().readValue(jp,
                                                com.msopentech.odatajclient.engine.data.metadata.edm.v3.Annotations.class));
                    } else {
                        ((com.msopentech.odatajclient.engine.data.metadata.edm.v4.Schema) schema).getAnnotationsList().
                                add(jp.getCodec().readValue(jp,
                                                com.msopentech.odatajclient.engine.data.metadata.edm.v4.Annotations.class));
                    }
                } else if ("Action".equals(jp.getCurrentName())) {
                    jp.nextToken();
                    ((com.msopentech.odatajclient.engine.data.metadata.edm.v4.Schema) schema).getActions().
                            add(jp.getCodec().readValue(jp, Action.class));
                } else if ("Annotation".equals(jp.getCurrentName())) {
                    jp.nextToken();
                    ((com.msopentech.odatajclient.engine.data.metadata.edm.v4.Schema) schema).getAnnotations().
                            add(jp.getCodec().readValue(jp, Annotation.class));
                } else if ("Function".equals(jp.getCurrentName())) {
                    jp.nextToken();
                    ((com.msopentech.odatajclient.engine.data.metadata.edm.v4.Schema) schema).getFunctions().
