...
/**
 * <p>Java class for TValueTerm complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="TValueTerm">
 *   &lt;complexContent>
...
@XmlType(name = "TValueTerm", propOrder = {
    "documentation",
    "collectionTypeOrReferenceTypeOrRowType",
    "any"
})
public class TValueTerm {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "RowType", type = TRowType.class),
        @XmlElement(name = "ReferenceType", type = TReferenceType.class),
        @XmlElement(name = "CollectionType", type = TCollectionType.class)
    })
