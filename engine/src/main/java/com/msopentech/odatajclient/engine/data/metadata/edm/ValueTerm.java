...
public class ValueTerm {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "RowType", type = RowType.class),
        @XmlElement(name = "ReferenceType", type = ReferenceType.class),
        @XmlElement(name = "CollectionType", type = CollectionType.class)
    })
