...
public class AssociationSetModificationFunction {
    ...
    protected List<ModificationFunctionMappingEndProperty> endProperty;
     ...
     *
     */
    public List<ModificationFunctionMappingEndProperty> getEndProperty() {
        if (endProperty == null) {
            endProperty = new ArrayList<ModificationFunctionMappingEndProperty>();
        }
