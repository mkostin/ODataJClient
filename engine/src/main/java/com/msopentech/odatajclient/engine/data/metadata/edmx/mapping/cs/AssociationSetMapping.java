...
public class AssociationSetMapping {
    ...
    protected List<EndProperty> endProperty;

    @XmlElement(name = "Condition")
    protected List<Condition> condition;

    @XmlElement(name = "ModificationFunctionMapping")
    protected AssociationSetModificationFunctionMapping modificationFunctionMapping;
     ...
     *
     */
    public List<EndProperty> getEndProperty() {
        if (endProperty == null) {
            endProperty = new ArrayList<EndProperty>();
        }
     ...
     *
     */
    public AssociationSetModificationFunctionMapping getModificationFunctionMapping() {
     ...
     *
     */
    public void setModificationFunctionMapping(AssociationSetModificationFunctionMapping value) {
