...
public interface InvokeRequestFactory extends Serializable {
     ...
     */
    <T extends ODataInvokeResult> ODataInvokeRequest<T> getInvokeRequest(
            URI uri, EdmMetadata metadata, FunctionImport functionImport);
    ...
    <T extends ODataInvokeResult> ODataInvokeRequest<T> getInvokeRequest(
            URI uri, EdmMetadata metadata, FunctionImport functionImport, Map<String, ODataValue> parameters);
}
