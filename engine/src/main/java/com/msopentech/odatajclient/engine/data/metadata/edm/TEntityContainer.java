...
public class TEntityContainer extends AbstractAnnotated {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "EntitySet", type = TEntityContainer.TEntitySet.class),
        @XmlElement(name = "AssociationSet", type = TEntityContainer.TAssociationSet.class),
        @XmlElement(name = "FunctionImport", type = TEntityContainer.TFunctionImport.class),
    ...
    public static class TAssociationSet {
        ...
        @XmlElement(name = "End")
        protected List<TEntityContainer.TAssociationSet.End> end;
         ...
         *
         */
        public List<TEntityContainer.TAssociationSet.End> getEnd() {
            if (end == null) {
                end = new ArrayList<TEntityContainer.TAssociationSet.End>();
            }
            return this.end;
        }
    ...
    public static class TFunctionImport extends AbstractAnnotated {
        ...
        public List<TFunctionImportParameter> getParameters() {
            return getJAXBElements(TFunctionImportParameter.class);
        }

        public String getFunctionImportReturnType() {
            List<TFunctionImportReturnType> functionImportReturnTypes =
                    getJAXBElements(TFunctionImportReturnType.class);
