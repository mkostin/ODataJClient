...
public class TEntityContainerMapping {

    @XmlElements({
        @XmlElement(name = "FunctionImportMapping", type = TFunctionImportMapping.class),
        @XmlElement(name = "EntitySetMapping", type = TEntitySetMapping.class),
        @XmlElement(name = "AssociationSetMapping", type = TAssociationSetMapping.class)
    })
