...
public class TEntityTypeModificationFunctionMapping {

    @XmlElement(name = "DeleteFunction")
    protected TEntityTypeModificationFunction deleteFunction;

    @XmlElement(name = "InsertFunction")
    protected TEntityTypeModificationFunctionWithResult insertFunction;

    @XmlElement(name = "UpdateFunction")
    protected TEntityTypeModificationFunctionWithResult updateFunction;
     ...
     *
     */
    public TEntityTypeModificationFunction getDeleteFunction() {
     ...
     *
     */
    public void setDeleteFunction(TEntityTypeModificationFunction value) {
     ...
     *
     */
    public TEntityTypeModificationFunctionWithResult getInsertFunction() {
     ...
     *
     */
    public void setInsertFunction(TEntityTypeModificationFunctionWithResult value) {
     ...
     *
     */
    public TEntityTypeModificationFunctionWithResult getUpdateFunction() {
     ...
     *
     */
    public void setUpdateFunction(TEntityTypeModificationFunctionWithResult value) {
