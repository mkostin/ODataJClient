...
public class TDiagram {
    ...
    @XmlElements({
        @XmlElement(name = "InheritanceConnector", type = TInheritanceConnector.class),
        @XmlElement(name = "AssociationConnector", type = TAssociationConnector.class),
        @XmlElement(name = "EntityTypeShape", type = TEntityTypeShape.class)
    })
