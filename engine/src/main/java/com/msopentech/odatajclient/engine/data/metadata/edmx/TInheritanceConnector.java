...
public class TInheritanceConnector {

    @XmlElement(name = "ConnectorPoint")
    protected List<TConnectorPoint> connectorPoint;
     ...
     *
     */
    public List<TConnectorPoint> getConnectorPoint() {
        if (connectorPoint == null) {
            connectorPoint = new ArrayList<TConnectorPoint>();
        }
