...
@XmlSeeAlso({
    TEntityTypeModificationFunctionWithResult.class
})
public class TEntityTypeModificationFunction {

    @XmlElements({
        @XmlElement(name = "ScalarProperty", type = TModificationFunctionMappingScalarProperty.class),
        @XmlElement(name = "AssociationEnd", type = TModificationFunctionMappingAssociationEnd.class),
        @XmlElement(name = "ComplexProperty", type = TModificationFunctionMappingComplexProperty.class)
    })
