...
public class V3Deserializer extends AbstractDeserializer {

    private static final long serialVersionUID = -8221085862548914611L;

    public V3Deserializer(final ODataClient client) {
        super(client);
    }

    @Override
    public V3Edmx toMetadata(final InputStream input) {
        try {
            return getXmlMapper().readValue(input, V3Edmx.class);
        } catch (Exception e) {
