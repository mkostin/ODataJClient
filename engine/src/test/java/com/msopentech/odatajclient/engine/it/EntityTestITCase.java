...
public class EntityTestITCase extends AbstractTest{
	//retrieve entity
	...
	private void retreiveEntityTestWithSelect(final ODataPubFormat reqFormat, final String acceptFormat,final String selectFormat){
		final ODataURIBuilder uriBuilder = new ODataURIBuilder(testDefaultServiceRootURL).
	...
	private void retreiveEntityTestWithSelectAndExpand(final ODataPubFormat reqFormat, final String acceptFormat, final String selectFormat, String expandFormat){
		final ODataURIBuilder uriBuilder = new ODataURIBuilder(testDefaultServiceRootURL).
	...
	// genral query test
	private void generalQuery(final ODataPubFormat format, String acceptFormat, final String navigationQuery, String links ) {
		final ODataURIBuilder uriBuilder = new ODataURIBuilder(testDefaultServiceRootURL).
