...
public class GeoSpacialTestITCase extends AbstractTest{
	...
	public void geoSpacialTest(final ODataPubFormat format,final String contentType,final String prefer,final int id) {
		try{
	        ...
	        new ODataGeospatialValue.Builder().setType(EdmSimpleType.GEOGRAPHY_MULTI_POINT).
	        ...
	        new ODataGeospatialValue.Builder().setType(EdmSimpleType.GEOGRAPHY_LINE_STRING).
	        ...
	        entity.addProperty(ODataFactory.newPrimitiveProperty("GeogMultiLine",
	                new ODataGeospatialValue.Builder().setType(EdmSimpleType.GEOGRAPHY_MULTI_LINE_STRING).
	        ...
	        final GeospatialCollection collection = new GeospatialCollection(Geospatial.Dimension.GEOGRAPHY, geospatialCollection);
	        ...
	        new ODataGeospatialValue.Builder().setType(EdmSimpleType.GEOMETRY_POINT).
	        ...
	        new ODataGeospatialValue.Builder().setType(EdmSimpleType.GEOMETRY_POLYGON).
	        ...
	        final GeospatialCollection geomCollection = new GeospatialCollection(Geospatial.Dimension.GEOMETRY,geomspatialCollection);
	        entity.addProperty(ODataFactory.newPrimitiveProperty("GeomCollection",
	        new ODataGeospatialValue.Builder().setType(EdmSimpleType.GEOMETRY_COLLECTION).
	        ...
	        updateLinePoints.add(updatePoint2);
	        updateLinePoints.add(updatePoint1);
	        final Polygon updatePolygon =new Polygon(Geospatial.Dimension.GEOGRAPHY, updateLinePoints, updateLinePoints);
