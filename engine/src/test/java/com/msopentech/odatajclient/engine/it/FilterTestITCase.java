...
public class FilterTestITCase extends AbstractTest{
	...
	public void logical() {
		...
		filterQueryTest("Car","VIN le 18 or VIN gt 12", 10);
		filterQueryTest("Car","VIN add 5 gt 11", 10);
	}
	//arithmetic operations
	@Test
	public void arithmetic(){
		filterQueryTest("Car","VIN add 5 gt 11", 10);
		filterQueryTest("Car","VIN div 2 gt 8", 3);
		filterQueryTest("Car","VIN mul 2 gt 30", 5);
		filterQueryTest("Car","VIN sub 2 gt 9", 9);
	}
	//string operations
	@Test
