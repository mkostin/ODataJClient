...
public class EntityUpdateMoreTestITCase extends AbstractTest {
    ...
    private void updateEntity(
        ...
        entity.addProperty(ODataObjectFactory.newPrimitiveProperty("Name",
                new ODataPrimitiveValue.Builder(client.getWorkingVersion()).setText("Updated Customer name").setType(EdmSimpleType.String).build()));
        // add key attribute
        entity.addProperty(ODataObjectFactory.newPrimitiveProperty("CustomerId",
                new ODataPrimitiveValue.Builder(client.getWorkingVersion()).setText(String.valueOf(-10)).setType(EdmSimpleType.Int32).build()));
        ...
        homePhone.add(ODataObjectFactory.newPrimitiveProperty("Extension",
                new ODataPrimitiveValue.Builder(client.getWorkingVersion()).setText("1243654265346267651534423ttrf").setType(EdmSimpleType.String).
                build()));
    ...
    private void updateEntityStringProperty(
        ...
        entitySetName.addProperty(ODataObjectFactory.newPrimitiveProperty(propertyName,
                new ODataPrimitiveValue.Builder(client.getWorkingVersion()).setText(newValue).build()));
    ...
    private void updateEntityDateProperty(
        ...
        assertNotEquals(newValue, oldValue);
        entitySetName.addProperty(ODataObjectFactory.newPrimitiveProperty(propertyName,
                new ODataPrimitiveValue.Builder(client.getWorkingVersion()).setText(newValue).setType(EdmSimpleType.DateTime).build()));
        update(type, entitySetName, format, etag);
        propertyValue = null;
        for (ODataProperty prop : entitySetName.getProperties()) {
            if (prop.getName().equals(propertyName)) {
    ...
    private void updateEntityIntProperty(
        ...
        entitySetName.addProperty(ODataObjectFactory.newPrimitiveProperty(propertyName,
                new ODataPrimitiveValue.Builder(client.getWorkingVersion()).setValue(newValue).setType(EdmSimpleType.Int32).build()));
        update(type, entitySetName, format, etag);
        propertyValue = null;
        for (ODataProperty prop : entitySetName.getProperties()) {
            if (prop.getName().equals(propertyName)) {
        ...
        entitySetName.addProperty(ODataObjectFactory.newPrimitiveProperty(propertyName,
                new ODataPrimitiveValue.Builder(client.getWorkingVersion()).setValue(oldValue).setType(EdmSimpleType.Int32).build()));
